...
export default function Index() {
  ...
  return (
    ...
    >
      ...
      >
        <Text style={{ fontSize: '28px', fontWeight: '700', color: scope.themeColor }}>数据总览</Text>
      ...
      >
        ...
        >
          {summaryList.map((item) => (
            ...
            >
              <Text style={{ fontSize: '13px', color: '#64748B', display: 'block', marginBottom: '6px' }}>
                {item.label}
              </Text>
              <Text style={{ fontSize: '22px', fontWeight: '700', color: '#0F172A', display: 'block' }}>
                {item.suffix === '%'
        ...
        >
          <View>
            <Text style={{ fontSize: '18px', fontWeight: '600', color: '#0F172A' }}>
              产能走势
            </Text> 
          </View>
        ...
        >
          {series.map((item) => {
            ...
            return (
              ...
              >
                <Text style={{ fontSize: '12px', color: '#0F172A', marginBottom: '6px' }}>
                  {item.value}
                </Text>
                <View
                  style={{
      ...
      >
        <View style={{ flex: 1 }}>
          ...
          <View style={{ marginTop: '6px' }}>
            <Text style={{ color: '#E0F2FE', fontSize: '13px' }}>
              精选专题，帮你快速上手与进阶
            </Text>
          </View>
        </View>
        <Image
          src='https://via.placeholder.com/72x72.png?text=%F0%9F%93%9D'
      ...
      >
        {[
          { title: '热门话题1', desc: '实时更新', color: '#FEE2E2' },
          { title: '发现好物', desc: '严选推荐', color: '#E0E7FF' },
          { title: '社区广场', desc: '一起讨论', color: '#D1FAE5' },
          { title: '我的收藏', desc: '随时查看', color: '#FFE4E6' }
        ].map((card) => (
          <View
            key={card.title}
          ...
          >
            ...
            />
            <Text style={{ fontSize: '15px', fontWeight: '600', color: '#0F172A' }}>
              {card.title}
            </Text>
            <View style={{ marginTop: '4px' }}>
              <Text style={{ fontSize: '12px', color: '#64748B' }}>{card.desc}</Text>
            </View>
          </View>
        ))}
      </View>
